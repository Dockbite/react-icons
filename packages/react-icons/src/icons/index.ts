...
export const icons: IconDefinition[] = [
  ...
  //     branch: "develop",
  //     hash: "32b07a5b798b84b97f2cbbb5b69ec7cb80472f73",
  //   },
  // },
  // {
  //   id: "sl",
  ...
  // },
  {
    ...
    contents: [
      {
        files: path.resolve(__dirname, "../../icons/flaticons/src/svgs/*.svg"),
        formatter: (name) => `Fli${name}`,
      },
    ],
    projectUrl: "https://www.flaticon.com/",
    license: "MIT",
    licenseUrl:
      "https://github.com/hamedyosefian/react-flaticons/blob/master/LICENSE",
    source: {
      type: "git",
      localName: "flaticons",
      remoteDir: "src/svgs/",
      url: "https://github.com/hamedyosefian/react-flaticons.git",
      branch: "master",
      hash: "8e52dcefbef2ed5c9ebfcb640612126b2ca131f3",
    },
  },
];
